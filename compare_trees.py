...
# len1=tr1.length()
# len2=tr2.length()
# sys.stdout.write('%s, %s, %d, %d, %d, %1.6f, %e, %e, %e\n' % (sys.argv[1], sys.argv[2], nl, fp, fn, rf, tr1_len, tr2_len, ed))
sys.stdout.write('%s, %s, %d, %d, %d, %1.6f\n' % (sys.argv[1], sys.argv[2], nl, fp, fn, rf))
